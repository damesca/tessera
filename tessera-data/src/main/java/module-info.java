open module tessera.data {
  ...
  uses com.quorum.tessera.data.PrivacyGroupDAO;
    uses com.quorum.tessera.data.ExtendedPrivacyDAO;
  ...
  provides com.quorum.tessera.data.DataSourceFactory with
	...
	provides com.quorum.tessera.data.ExtendedPrivacyDAO with
			com.quorum.tessera.data.internal.ExtendedPrivacyDAOProvider;
}
