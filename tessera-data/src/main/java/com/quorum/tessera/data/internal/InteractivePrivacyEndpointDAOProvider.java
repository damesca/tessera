...
public class InteractivePrivacyEndpointDAOProvider {
    
    private static final Logger LOGGER = 
        LoggerFactory.getLogger(InteractivePrivacyEndpointDAOProvider.class);

    public static InteractivePrivacyEndpointDAO provider() {

        /*LOG*/System.out.println(" >>> [InteractivePrivacyEndpointDAOProvider] provider()");
        ...
        return new InteractivePrivacyEndpointDAOImpl(entityManagerFactory);
    }
