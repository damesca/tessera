...
public class ExtendedPrivacyDAOProvider {

    private static final Logger LOGGER = LoggerFactory.getLogger(ExtendedPrivacyDAOProvider.class);

    public static ExtendedPrivacyDAO provider() {
      ...
      return new ExtendedPrivacyDAOImpl(entityManagerFactory);
    }
}
