...
public class PrivateOutputDAOProvider {
    
    private static final Logger LOGGER = 
        LoggerFactory.getLogger(PrivateOutputDAOProvider.class);

    public static PrivateOutputDAO provider() {

        /*LOG*/System.out.println(" >>> [PrivateOutputDAOProvider] provider()");
        ...
        return new PrivateOutputDAOImpl(entityManagerFactory);
    }
